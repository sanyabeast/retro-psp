...
function BasicBot:on_tick(delta)
    ...
    self.current_direction[1] = Math.lerpf(self.current_direction[1], self.target_direction[1], self.drag * delta)
    self.current_direction[2] = Math.lerpf(self.current_direction[2], self.target_direction[2], self.drag * delta)

    self.game_object:translate(
        self.current_direction[1] * delta * self.move_velocity,
        self.current_direction[2] * delta * self.move_velocity,
        0
    )
