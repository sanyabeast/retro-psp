...
function Component:update_render_data()
    return
end
-- COMPONENTS SELCTIVE
function Component:get_component(...)
    return self.game_object:get_component(...)
end
function Component:get_component_with_class(...)
    return self.game_object:get_component_with_class(...)
end
return Component
